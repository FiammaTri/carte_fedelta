...
public class DataLoader implements CommandLineRunner {
	...
	private static final List<Map<String, String>> STORE = List.of(
			Map.of("store_name", "Ikea", "logo_name", "Ikea"),
	...
	private static final List<Map<String, Long>> CARD = List.of(
			Map.of("number", 123456L),
